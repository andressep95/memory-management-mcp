...
public record CommitIndexed(MemoryChangeId id, String projectId, CommitHash commitHash, Instant occurredAt) {

    public CommitIndexed(MemoryChangeId id, String projectId, CommitHash commitHash) {
